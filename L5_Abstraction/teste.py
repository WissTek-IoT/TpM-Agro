...
if (user_input == 0):
    ...
    print(f"Relative Error in Pump Activation: {round(100*abs(pump_active_in_validation - pump_active_in_prediction)/pump_active_in_validation, 2)}%")
    a = 0
    ...
    # print(predictions_for_validation_set)
    # print(X_valid[0])
